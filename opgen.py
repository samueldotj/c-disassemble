...
#
# special operator types for internal purposes.
#
spl_mnm_types = [   'd3vil',      \
                    'na',         \
                    'grp_reg',    \
...
for node in tlNode.childNodes:
    ...
    for n in node.childNodes:
        ...
        # and ignore them
        # 
        if operator == 'pause' or \
           ( operator == 'nop' and opc[0] == '90' ) or \
           operator == 'invalid' or \
            operator == 'db':
            continue
...
f.write('\n' )
f.write('ITAB__VENDOR_INDX__AMD = 0\n' )
f.write('ITAB__VENDOR_INDX__INTEL = 1\n' )
f.write('\n')


f.write('\n' )
f.write('ITAB__MODE_INDX__16 = 0\n' )
f.write('ITAB__MODE_INDX__32 = 1\n' )
f.write('ITAB__MODE_INDX__64 = 2\n' )
f.write('\n')


f.write('\n' )
f.write('ITAB__MOD_INDX__NOT_11 = 0\n' )
f.write('ITAB__MOD_INDX__11 = 1\n' )
f.write('\n')
